...
| B1.1 | Validación de Enlaces de Correo y Respuestas Mínimas | security | LOCAL_EVIDENCE_ONLY | c126e94b2155355e0e52d4c2510579fc4deb2e43 | NO_VERIFICADO | server.ts, src/lib/__tests__/b1_perimeter.test.ts, .env.example, docs/governance/* | Pruebas unitarias portalLink (9 tests B1.1) y linter/build verdes | Pendiente gate fundador | B1 | Allowlist se configura por entorno (PORTAL_ALLOWED_HOSTS) | 2026-08-04 |
