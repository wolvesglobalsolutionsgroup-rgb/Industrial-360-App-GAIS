...
| **Certificados Especiales (Anexos B a L)** | Formatos impresos adjuntos / PDF sellado | Emisor / Receptores Especialidad | Adjunto al Anexo A en sitio / Databook | Sec. 7.2.b, 8.7.3 |
...
| **Notificación Escrita a Trabajadores** | Firma / Constancia en sitio (Renglón 11.k) | Emisor, Receptor, Ejecutor | Formato Anexo A en sitio | Sec. 8.1.2.f |
...
## 2. REQUISITOS DE CUSTODIA Y RETENCIÓN
* **Retención Mínima Normativa:** Tres (3) meses continuos en archivo físico post-cierre (§8.7.2).
* **Distribución de Copias:**
  * **Original:** Conservado por el Emisor / Custodio de la Instalación (§8.7.3).
  * **Copia:** Conservada por el Receptor del Permiso en el sitio de trabajo (§8.1.1.d, 8.7.3).
