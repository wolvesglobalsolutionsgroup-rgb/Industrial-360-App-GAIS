...
| **ISA 20** | Instrument Specification Forms | Norma Internacional ISA | CONFIRMED_SPECIFICATION | Hojas de datos e inspección técnica de instrumentos de proceso. |
...
| **PDVSA IR-S-04** | Sistema de Permisos de Trabajo | PDF Oficial PDVSA | VERIFIED (Págs. 1-69) | Permiso de trabajo base para calibración y desvío de instrumentación (Renglón 11.n). |
| **PDVSA SI-S-20** | Procedimientos de Trabajo | PDF Oficial PDVSA | VERIFIED (Págs. 1-12) | Estructura de procedimientos de calibración y pruebas de campo. |
| **PDVSA IR-E-01** | Clasificación Eléctrica de Áreas | Norma PDVSA Citada | MISSING_SOURCE | Verificación de equipos e instrumentos a prueba de explosión (Ex-proof / Ex-i). |
